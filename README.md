...
- 其它服务程序使用本代理可以参见 run-poe-fastapi-proxy.sh 脚本
...
```bash
$ git clone https://github.com/teryfly/clash-for-linux.git
```
...
通过浏览器访问 `start.sh` 执行成功后输出的地址，例如：http://192.168.120.177:9090/ui
